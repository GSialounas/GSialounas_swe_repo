function [L2Rt,L2Rt_arr,c_0_coeff_arr_new, c_0_coeff_arr_old,R_h_burger,max_IUx] = compute_burger_rec_space_3_time_3(x,dist_x_pl,dist_x_min,uold,u,evalt,tj,dt,f_h_old,f_h_new,spatial_disc,c)
global nq xq wq
%uold defined at tn
%u defined at t
% R = IU_t + IU_x
...
for iq = 1:nq
    ...
    R_h_burger= IUt + IU.*IUx;
    L2Rt = L2Rt + sum(wq(iq)*dist_x_pl.*(IUt + IU.*IUx).^2);
    L2Rt_arr = L2Rt_arr +wq(iq)*dist_x_pl.*(IUt + IU.*IUx).^2;
