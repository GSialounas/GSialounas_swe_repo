function var_out = fn_plot_WENO(init_conds)
c={};
...
c=struct2cell(load(['SSP3WENO3_cell_arr_file_',init_conds,'.mat']));
...
saveas(figgy,['/Users/gs1511/Desktop/GSialounas_swe_repo/figures/fig_SSP3WENO3_',init_conds,'_plots_1x5_linadvect'],'png');%char(Scheme_string)
