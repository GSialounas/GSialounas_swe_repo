...
scheme_string= 'SHW_RK3_LXF_rec3_fixed';
...
%     v= zeros(size(h));
    ...
    bound_arr_h_eoc  = [];%zeros(1,ceil(T/dt));
    bound_arr_hv_eoc = [];%zeros(1,ceil(T/dt));
